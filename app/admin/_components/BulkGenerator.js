      ...
      <div style={S.card}>
        ...
        <form onSubmit={handleBulk}>
          ...
          <div style={{ display:'flex', gap:'0.75rem', alignItems:'center' }}>
            ...
            {status === 'done' && (
              <button type="button" onClick={reset} style={S.btn('ghost')}>
                Generate more
              </button>
            )}
          </div>
      ...
      {isGenerating && (
        <div style={{ ...S.card, marginTop:'1.5rem', textAlign:'center', padding:'2.5rem' }}>
          ...
          <p style={{ margin:'0.5rem 0 0', fontSize:'0.78rem', color:'#aaa' }}>
            Each article is generated, checked for duplicates, and saved automatically.
          </p>
        </div>
      )}
      ...
      {summary && (
        <div style={{ ...S.card, marginTop:'1.5rem', background:'#f3fbf6', border:'1px solid #b7dfc8' }}>
          <p style={{ margin:'0 0 0.25rem', fontWeight:'700', color:'#1b5e20', fontSize:'1rem' }}>
            ✓ {summary.generated + summary.skipped} articles generated ({summary.generated} success, {summary.skipped} skipped)
          </p>
