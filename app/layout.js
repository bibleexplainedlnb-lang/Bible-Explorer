...
export const metadata = {
  title: { default: 'Bible Explorer', template: '%s | Bible Explorer' },
  description: 'Explore the Bible — read KJV Scripture, study topics, find answers, and grow in faith.',
};

export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body className="min-h-screen flex flex-col" style={{ backgroundColor: '#faf7f2', color: '#1a1208' }}>
        ...
        <footer style={{ backgroundColor: '#1e2d4a', color: '#8b9bb4', padding: '2rem 0', marginTop: '4rem' }}>
          <div style={{ maxWidth: '72rem', margin: '0 auto', padding: '0 1rem', textAlign: 'center', fontSize: '0.875rem' }}>
            <p style={{ color: '#d4a017', marginBottom: '0.5rem', fontFamily: 'Georgia, serif', fontSize: '1rem' }}>
              ✝ Bible Explorer
            </p>
            <p>KJV Scripture text via{' '}
