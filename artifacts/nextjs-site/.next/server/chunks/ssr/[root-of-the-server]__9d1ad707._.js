...
;
;
const guides = __TURBOPACK__imported__module__$5b$project$5d2f$artifacts$2f$nextjs$2d$site$2f$data$2f$content$2e$json__$28$json$29$__["default"].guides;
...
function resolveQuestions(slugs) {
    return slugs.map((s)=>questions.find((q)=>q.slug === s)).filter((q)=>q !== undefined);
}
function resolveTopics(slugs) {
    return slugs.map((s)=>topics.find((t)=>t.slug === s)).filter((t)=>t !== undefined);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d1ad707._.js.map